...
class TestConnectionsList:
    ...
    def test_connections_list_truncated(self) -> None:
        ...
        mock_response = json.dumps({
            "node": "pCube1",
            "connections": [{"source": f"node{i}.out", "destination": "pCube1.in"} for i in range(500)],
            "count": 500,
            "truncated": True,
            "total_count": 1000,
            "errors": None,
...
class TestConnectionsHistory:
    ...
    def test_connections_history_input(self) -> None:
        ...
        mock_response = json.dumps({
            ...
            "history": [
                ...
                {"name": "polyExtrudeFace1", "type": "polyExtrudeFace", "depth": 2, "direction": "input"},
            ],
            "count": 2,
            "errors": None,
        })
    ...
    def test_connections_history_output(self) -> None:
        ...
        mock_response = json.dumps({
            "node": "pCube1",
            "history": [
                {"name": "skinCluster1", "type": "skinCluster", "depth": 1, "direction": "output"},
            ],
            "count": 1,
            "errors": None,
        })
